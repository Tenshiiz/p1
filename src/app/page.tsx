        ...
        <div className="relative h-screen z-10 flex flex-col justify-center items-center md:mt-[-50px] lg:block lg:mt-[50px]">
          ...
          <div className="flex">
            <div className="max-w-2xl flex flex-col justify-center items-center text-center lg:text-left lg:block">
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight text-white">Transforme seu Negócio com os nossos <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">Agentes de IA</span></h1>
              ...
              <button
                className="mt-7 text-white w-full py-3 px-4 bg-sky-700 cursor-pointer lg:w-64 rounded-xl hover:bg-sky-800 transition-all"
